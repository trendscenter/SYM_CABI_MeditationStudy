...
expName = 'SYM_CABI_RSfMRI_2'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='./data/SYM_CABI_RSfMRI_2_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    hf.task_trigger(value="7", port=port, outlet=outlet, desc="Fixation Image")
    ...
    hf.task_trigger(value="8", port=port, outlet=outlet, desc="Fixation Image")
