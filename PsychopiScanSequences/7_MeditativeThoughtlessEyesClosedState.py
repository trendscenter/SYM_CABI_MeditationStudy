...
expName = 'SYM_CABI_MeditativeState'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='./data/SYM_CABI_MeditativeState_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    rs_cross = visual.ImageStim(
        win=win,
        name='rs_cross',
        image='./images/SYMeditationTaskEyesClosed.png', mask=None, anchor='center',
    ...
    hf.task_trigger(value="13", port=port, outlet=outlet, desc="Meditation Image")
    ...
    hf.task_trigger(value="14", port=port, outlet=outlet, desc="Meditation Image")
